...
async function buildAuthorizeUrl(req, options, storage) {
    ...
    const state = Object.assign({ serverUrl: serverUrl, clientId: options.clientId, redirectUri: options.redirectUri || "", scope: options.scope || "" }, extensions);
